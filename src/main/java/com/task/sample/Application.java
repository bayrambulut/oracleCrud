...
public class Application implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        /*
        customerRepository.save(new Customer("mkyong","111@yahoo.com", new Date()));
        customerRepository.save(new Customer("yflow","222@yahoo.com", new Date()));
        customerRepository.save(new Customer( "zilap","333@yahoo.com", new Date()));
         */
